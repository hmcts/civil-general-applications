...
import static uk.gov.hmcts.reform.civil.controllers.FeesPaymentController.FEES_PAYMENT_REQUEST_URL;
import static uk.gov.hmcts.reform.civil.controllers.FeesPaymentController.FEES_PAYMENT_STATUS_URL;
...
public class FeesPaymentControllerTest extends BaseIntegrationTest {
    ...
    void shouldReturnServiceRequestPaymentStatus(String status) {
        ...
        when(paymentsClient.getGovPayCardPaymentStatus("RC-1701-0909-0602-0418", BEARER_TOKEN))
            .thenReturn(response);
        doGet(BEARER_TOKEN, FEES_PAYMENT_STATUS_URL, "123", "RC-1701-0909-0602-0418")
