...
public enum DocmosisTemplates {
    ...
    WRITTEN_REPRESENTATION_SEQUENTIAL("OrderWrittenReps.docx", "Order_Written_Representation_Sequential.pdf"),
    WRITTEN_REPRESENTATION_CONCURRENT("OrderWrittenRepsConcurrent.docx", "Order_Written_Representation_Concurrent.pdf");
