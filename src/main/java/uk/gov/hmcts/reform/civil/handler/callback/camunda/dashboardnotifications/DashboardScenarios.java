...
public enum DashboardScenarios {
    ...
    SCENARIO_AAA6_APPLICANT_PROCEED_OFFLINE_APPLICANT("Scenario.AAA6.Update.GeneralApps.ApplicationProceedsOffline.Applicant"),
    SCENARIO_AAA6_APPLICANT_PROCEED_OFFLINE_RESPONDENT("Scenario.AAA6.Update.GeneralApps.ApplicationProceedsOffline.Respondent");
