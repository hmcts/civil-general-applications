...
public enum DashboardScenarios {
    ...
    SCENARIO_AAA6_GENERAL_APPLICATION_ISSUED("Scenario.AAA6.GeneralApplication.Issue.Payment.Required"),
    SCENARIO_AAA6_GENERAL_APPLICATION_SUBMITTED("Scenario.AAA6.GeneralApplication.Submitted");
