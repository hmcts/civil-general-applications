...
public enum CaseEvent {
    ...
    VERIFY_TO_PROCEED_IN_HERITAGE(USER),
    ...
    START_GENERAL_APP_BUSINESS_PROCESS(CAMUNDA),
    END_GENERAL_APP_BUSINESS_PROCESS(CAMUNDA),
    ...
    APPLICATION_CLOSED_UPDATE_PARENT_CLAIM(CAMUNDA),

    APPLICATION_OFFLINE_UPDATE_PARENT_CLAIM(CAMUNDA),
