...
@SpringBootTest(classes = {
    StartHearingScheduledBusinessProcessCallbackHandler.class,
    JacksonAutoConfiguration.class,
    CaseDetailsConverter.class
})
class StartHearingScheduledBusinessProcessCallbackHandlerTest extends BaseCallbackHandlerTest {

    @Autowired
    private StartHearingScheduledBusinessProcessCallbackHandler startHearingScheduledBusinessProcessCallbackHandler;
    ...
    void shouldSetStatusStarted_whenInitialStateIs(BusinessProcessStatus status) {
        ...
        AboutToStartOrSubmitCallbackResponse response
            ...
            startHearingScheduledBusinessProcessCallbackHandler.handle(params);
