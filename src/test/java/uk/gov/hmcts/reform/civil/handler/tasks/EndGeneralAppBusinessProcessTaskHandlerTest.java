...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.END_GENERAL_APP_BUSINESS_PROCESS;

@SpringBootTest(classes = {
    EndGeneralAppBusinessProcessTaskHandler.class,
    JacksonAutoConfiguration.class,
    CaseDetailsConverter.class,
})
@ExtendWith(SpringExtension.class)
class EndGeneralAppBusinessProcessTaskHandlerTest {
    ...
    @Autowired
    private EndGeneralAppBusinessProcessTaskHandler handler;
    ...
    void init() {
        ...
        when(mockExternalTask.getAllVariables())
            .thenReturn(Map.of(
                "caseId", CASE_ID,
                "caseEvent", END_GENERAL_APP_BUSINESS_PROCESS
            ));
    }
    ...
    void shouldTriggerEndBusinessProcessCCDEventAndUpdateBusinessProcessStatusToFinished_whenCalled() {
        ...
        when(coreCaseDataService.startUpdate(CASE_ID, END_GENERAL_APP_BUSINESS_PROCESS)).thenReturn(startEventResponse);
        ...
        verify(coreCaseDataService).startUpdate(CASE_ID, END_GENERAL_APP_BUSINESS_PROCESS);
    ...
    private StartEventResponse startEventResponse(CaseDetails caseDetails) {
        return StartEventResponse.builder()
            .token("1234")
            .eventId(END_GENERAL_APP_BUSINESS_PROCESS.name())
