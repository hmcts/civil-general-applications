...
class VerifyToProceedInHeritageEventCallbackHandlerTest extends BaseCallbackHandlerTest {

    @Mock
    private ApplicationEventPublisher applicationEventPublisher;

    @InjectMocks
    private VerifyToProceedInHeritageEventCallbackHandler handler;
    ...
    class SubmitCallback {
        ...
        void shouldRespondWithStateChangedWhenApplicationIsLive(CaseState state) {
            ...
            ArgumentCaptor<TakeApplicationOfflineEvent> argument = forClass(TakeApplicationOfflineEvent.class);
    ...
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents()).contains(VERIFY_TO_PROCEED_IN_HERITAGE);
    }
}
