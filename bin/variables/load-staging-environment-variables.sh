...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://civil-ga-definition-store-staging.aat.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=https://civil-ga-camunda-staging.aat.platform.hmcts.net"
